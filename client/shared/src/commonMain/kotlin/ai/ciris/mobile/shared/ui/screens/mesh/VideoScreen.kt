 ...
 */
@Composable
fun VideoScreen(onIssueClick: (String) -> Unit = {}) {
    ComingSoonPlaceholder(
        title = localizedString("mesh.video.title").ifEmpty { NavSurface.Video.label },
        icon = NavSurface.Video.icon,
        description = localizedString("mesh.video.description"),
